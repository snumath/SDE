...
\Rightarrow \mathcal{L}(\{a\}) = \lim_{n\rightarrow} \mathcal{L}((a-\frac{1}{n}, a+\frac{1}{n})) = 0
)$\\
...
\begin{rem}
Radon-Nikodym-Lebesgue decomposition implies that any measure can be decomposed as density part and non-density part.
\end{rem}
