...
% \part{Textbook name} Comment out!
...
Q.V. of RV is constant but Q.V. of $C^1$ function is zero.
\end{exmp}
...
Then, 
\begin{equation}
\frac{1}{\sqrt n}\left[Y_1 + \cdots Y_n \right] \rightarrow N(0,1^2)\tag{*}
\end{equation}
\end{thm}
...
= \sqrt{t} \frac{1}{\sqrt{nt}} (X_1 + \cdots + X_{nt}) \sim (0,t)$



\textit{cf.} $N(\mu, \sigma^2)$ is normal random variable with mean $\mu$ and variation $\sigma^2$.
Using the above,
$$
