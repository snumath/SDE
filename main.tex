...
% 여기부터 기말
% Ito integral and Ito' Formula (2 weeks)
% SDE (3 weeks)
...
Brownian filtration is essential in Ito's integral since
in Wiener's integral, we concern
$$\int_a^b f(s) dB(s) : \omega \mapsto \int_a^b f(s) dB(s,\omega),$$
while
in Ito's integral, we concern
...
In this chapter, we will define Ito's integral with that condition.
